...
export function VehicleListPage(props: VehicleListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getVehicles({
        relations: ['user', 'performance.count', 'reservation.count', 'usage_data.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['make.contains', 'model.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('reservation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('usage_data', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'usage_data',
          header: 'Usage Data',
          accessorKey: 'usage_data',
          cell: ({ row: { original: record } }: any) => record?._count?.usage_data,
        }
      : null,
