...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'reservation.create': {
    roles: ['user', 'vehicle-owner'],
    key: 'new-reservation-created',
    tenantPath: ['organization', 'user', 'vehicle', 'reservation'],
    userPath: [],
  },
  'usage_data.update': {
    roles: ['user', 'vehicle-owner'],
    key: 'vehicle-usage-data-updated',
    tenantPath: ['organization', 'user', 'vehicle', 'usage_data'],
    userPath: [],
  },
};
